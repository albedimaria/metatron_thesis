...
import '../../oldStyles/controlKnobsStyle.css'
import {findLabelValue, mapValuesToLabels} from "../../functions/FromValuesToKnobs";
import {useData} from "../../data/backendData/DataContext";
import {useGeomControls} from "../../leva/firstSixFeat/GeomControlsContext";
...
export const KnobsProvider = ({ children }) => {
    ...
    const knobData = [
        ...
        { name: "timbre", position: [25, -20, 0], value: tempTimbre,
